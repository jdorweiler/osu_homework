...
int getArgv(const int &argc,char **argv, string &filename){
    ...
    storeMap(12, "Uses some form of conditional", __LINE__, 4);
...
void printVector(std::vector<AnimalPtr> &v, string &selection){
    ...
    storeMap(20, "Demonstrates how scope of variables works ** vector declared in a functions an passed around by ref",
             __LINE__, -12);
    storeMap(22, "Demonstrates function overloading ** this line uses overloaded ostream **", __LINE__, -5);
...
void printArray(int *array, int width){
        if(width == 0){
            ...
            storeMap(24, "Uses some form of recursion ** printed from recursive array function **", __LINE__, 0);
...
void calculator(){
    ...
    storeMap(6, "Uses variables in C++ ", __LINE__, -4);
...
void getInput(int &n, string s, int max){
    ...
    storeMap(18, "Uses at least one function that you define", __LINE__, 0); // this is a given one
}
...
void printOFS(ofstream &ofs, const string &filename){
    ...
    storeMap(40, "Defines classes covering the use of default constructors ** Animal subclasses use default constructors",
             __LINE__, 58);
    storeMap(41, "Demonstrates overloaded operators ** overloaded ostream in animal class **", 49, 0);
    ...
    storeMap(45, "Uses polymorphism  ** virtual ostream and getType functions for the sub classes of animal", 0, 0);
    ...
    storeMap(11, "Uses some form of type casting ** in storeMap function **", 0, 0);
